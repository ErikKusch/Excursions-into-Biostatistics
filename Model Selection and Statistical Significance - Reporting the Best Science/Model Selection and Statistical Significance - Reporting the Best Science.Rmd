...
\item The \textbf{shrinkage penalty} ($\lambda \sum\limits_{j}\beta_{j}^2$) is small when $\beta_{0}, \beta_{1}, ..., \beta_{p}$ are close to zero, thus shrinking penalty the estimates of $\beta_{j}$ towards zero.
\end{itemize}
